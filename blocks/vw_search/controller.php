<?php  
namespace Application\Block\VwSearch;
...
class Controller extends BlockController {
	...
	protected $btName = 'VWRoleSearch';
	protected $btDescription = 'Search the Volunteer Database for roles';
	protected $btTable = 'btDCVwSearch';
	...
	public function view() {
		$this->set('field_1_image', (empty($this->field_1_image_fID) ? null : $this->get_image_object($this->field_1_image_fID, 50, 50, false)));
	}
