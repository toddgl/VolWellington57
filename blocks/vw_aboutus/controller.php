<?php  
namespace Application\Block\VwAboutus;
...
class Controller extends BlockController {
	...
	protected $btName = 'vw_aboutus';
	protected $btDescription = 'About us page teaser';
	protected $btTable = 'btDCVwAboutus';
	...
	public function add() {
		...
		$field_2_default_content = 'Our aim is to find new ways to match <br/>people with volunteer roles.';
		$this->set('field_2_wysiwyg_content', $field_2_default_content);
		$field_3_default_content = 'The true definition of work is "meaningful,purposeful activity".<br/>
People work variously at paid employment,domestic and leisure<br/>
activities, and volunteering.<br/>
Community volunteering is a legitimate work option. It promotes<br/> self-worth,motivation and competence.In the wider community, <br/> it fosters goodwill and co-operation. Overall it enriches society\'s <br/>          economic and cultural life.';
		$this->set('field_3_wysiwyg_content', $field_3_default_content);
	}
