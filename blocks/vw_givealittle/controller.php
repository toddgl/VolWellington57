<?php  
namespace Application\Block\VwGivealittle;
...
class Controller extends BlockController {
	...
	protected $btName = 'GiveALittle';
	protected $btDescription = 'Link to Volunteer Wellingtons GiveALittle page';
	protected $btTable = 'btDCVwGivealittle';
	...
	public function view() {
		$this->set('field_1_image', (empty($this->field_1_image_fID) ? null : $this->get_image_object($this->field_1_image_fID, 200, 200, false)));
