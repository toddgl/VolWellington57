<?php  
namespace Application\Block\VwSmlink;
...
class Controller extends BlockController {
	...
	protected $btName = 'vw_smLink';
	protected $btDescription = 'Multi-purpose link block';
	protected $btTable = 'btDCVwSmlink';
	...
	public function view() {
		$this->set('field_1_image', (empty($this->field_1_image_fID) ? null : $this->get_image_object($this->field_1_image_fID, 40, 40, false)));
	}
