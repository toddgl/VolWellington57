<?php  
namespace Application\Block\Facebooklink;
...
class Controller extends BlockController {
	...
	protected $btName = 'FacebookLink';
	protected $btDescription = 'Image and Link to a Facebook page';
	protected $btTable = 'btDCFacebooklink';
