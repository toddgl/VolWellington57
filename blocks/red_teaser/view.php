...
<?php if (!empty($field_1_textbox_text)): ?>
	<div>
 		<h3 class="vol-font"><?php echo htmlentities($field_1_textbox_text, ENT_QUOTES, APP_CHARSET); ?></h3>
	</div>
<?php endif; ?>
...
<?php if (!empty($field_3_textbox_text)): ?>
	<div class="bg-danger bg-info col-md-8 pull-right">
	<div class="inside"><?php echo htmlentities($field_3_textbox_text, ENT_QUOTES, APP_CHARSET); ?><p></p>
<?php endif; ?>
