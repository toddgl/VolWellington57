<?php  
namespace Application\Block\RedTeaser;
...
class Controller extends BlockController {
	...
	protected $btName = 'Red Teaser';
	protected $btDescription = 'Read header teaser, e.g. Youth Volunteering';
	protected $btTable = 'btDCRedTeaser';
