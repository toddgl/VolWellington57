<?php  
namespace Application\Block\VwStoryBlock;
...
class Controller extends BlockController {
	...
	protected $btName = 'Story Block';
	protected $btDescription = 'For volunteer story snippets';
	protected $btTable = 'btDCVwStoryBlock';
