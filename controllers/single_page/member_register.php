...
class MemberRegister extends PageController
{
  ...
  public function regMember() {
    ...
    // Set email content
    $mailContent = "
    <p>You have received this mail from the Volunteer Wellington web site. The data below is that which has been entered by the New Member.</p>
    <p>The applying body should also have received this email, if they have entered a valid email address.</p>
    <fieldset>
    ...
    try {
      ...
      $mailService->to('julie@volunteerwellington.nz, info@volunteerwellington.nz, office@volunteerwellington.nz');
